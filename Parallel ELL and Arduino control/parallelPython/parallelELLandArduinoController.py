...
abMove01 = '2ma0000'+str(degreestoHex(15))  #Define a series of absolute movements. First ELL14 will be moving with regulat step sizes, the second will be moving to arbitrary positions as required by my application. 
abMove02 = '2ma0000'+str(degreestoHex(30))
abMove03 = '2ma0000'+str(degreestoHex(45))
abMove04 = '2ma0000'+str(degreestoHex(60))
abMove05 = '2ma0000'+str(degreestoHex(75))
abMove06 = '2ma0000'+str(degreestoHex(90))
abMove07 = '2ma0000'+str(degreestoHex(15))  #Define a series of absolute movements. First ELL14 will be moving with regulat step sizes, the second will be moving to arbitrary positions as required by my application. 
abMove08 = '2ma0000'+str(degreestoHex(30))
abMove09 = '2ma0000'+str(degreestoHex(45))
abMove10 = '2ma0000'+str(degreestoHex(60))
abMove11 = '2ma0000'+str(degreestoHex(75))
abMove12 = '2ma0000'+str(degreestoHex(90))
abMove13 = '2ma0000'+str(degreestoHex(15))   
abMove14 = '2ma0000'+str(degreestoHex(15))

absMoveStringArray = [abMove01, abMove02, abMove03, abMove04, abMove05, abMove06,abMove07,abMove08,abMove09,abMove10,abMove11,abMove12,abMove13,abMove14]

print('Loop starts \n\n')
time.sleep(1)
for idx in tqdm(range(0,len(absMoveStringArray))):    # In each iteration, first ELL14 takes a regular sized jog step, and second moves to an impirically determined absolute position
    ...
    ELLser.write((absMoveStringArray[idx]).encode('utf-8'))     # Move to absolute position
    time.sleep(1.0)
    if(ELLser.in_waiting > 0):
        serialString = ELLser.readline().decode('ascii')                
