...
Then use py_pol to calculate the properties of the Jones vector. The polarisation angle is not regularly sampled so to make sure we get good values for the polarisation values 
...
delta = 56 * degrees # The measured phase retardance of the birefringent microscope components

mPhaseAngle = 58 * degrees # The measured phase angle of the birefringent microscope components
# alpha = 0 * degrees
...
print(np.round(hwpVals[1]+82))
print(np.round(qwpVals[1])+82+34/2)
