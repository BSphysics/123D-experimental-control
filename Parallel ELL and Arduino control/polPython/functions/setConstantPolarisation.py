...
def setPol(fullFileName, stepNumber):
# fullFileName = r'D:\!User files\Ben\2023\2023_06_05 Ellipticity measurements with extra ELL14\2023_06_05 Ellip measurements MAITAI.xlsx'
    ...
    dfLPA = pd.read_excel(fullFileName, usecols='E')
    ...
    return round(serialtoDeg(HWPMoveArray[idx])), round(serialtoDeg(QWPMoveArray[idx])), int(dfLPA.values[idx+2])
